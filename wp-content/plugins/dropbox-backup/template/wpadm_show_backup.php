                    ...
                    <?php if (isset($data['md5']) && ($n = count($data['data'])) && is_array($data['data'][0])) { 
                            ...
                            <tr>
                                ...
                                <td onclick="shows('<?php echo md5( print_r($data['data'][$i], 1) );?>', this)" class="pointer">
                                    <?php 
                                        ...
                                        if ($data['data'][$i]['size'] != 0) {
                                            ...
                                            $e = "<strong style=\"color:#ff8104;\">". langWPADM::get('Backup in process create', false) . "</strong>";
                                        } else {
                                            $e = "<strong style=\"color:red;\">". langWPADM::get('Not available', false) . "</strong>&nbsp;&nbsp;(<a style=\"text-decoration:underline;\">".langWPADM::get('Why?', false)."</a>)"; 
                                        } 
                                        echo $e;
                                    ?>
                                ...
                                <td onclick="shows('<?php echo md5( print_r($data['data'][$i], 1) );?>', this)" class="pointer" style="padding: 0px;">
                                    <?php if ($data['data'][$i]['size'] != 0) { ?>
                                        ...
                                        <div style="margin-top :1px;float: left;"><?php echo langWPADM::get('Attention, backup creates', false);?></div>
                                        <?php } else {
                                        ?>
                            ...
                            <tr id="<?php echo md5( print_r($data['data'][$i], 1) );?>" style="display:none; ">
                                <?php if ($data['data'][$i]['size'] != 0) {?>
                                    ...
                                    ?>
                                    <td colspan="8">
                                        <?php langWPADM::get('Backup is created. If you are sure that the backup down(crashed), please ');?> 
                                        <a href="javascript:void(0)" onclick="window.open('<?php echo SERVER_URL_INDEX . 'support/?pl=dbp'?>')"><?php langWPADM::get('contact us'); ?></a>.
                                    </td>
                                    <?php
                                    } else { ?>
                                    <td colspan="2">
