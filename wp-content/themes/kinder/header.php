...
>
	...
	<div class="sidemenu_wrap swpLeftPos">
		<div class="sidemenu_button" style="background-image:url(<?php echo $logo_icon; ?>)"></div>
	...
	<div class="main_content">
		...
		<div class="boxedWrap">
			...
			if ($video_bg_show) {
				...
				if (!empty($youtube)) {
					?>
					<div class="videoBackground<?php echo $overlay ? ' overlay' : ''; ?>" data-youtube-code="<?php echo $youtube; ?>"></div>
					<?php
				} else if (!empty($video)) {
					$info = pathinfo($video);
					...
					?><video class="videoBackground" width="1280" height="720" data-width="1280" data-height="720" preload="metadata" autoplay loop src="<?php echo $video; ?>">
						<source src="<?php echo $video; ?>" type="video/<?php echo $ext; ?>"></source>
					</video></div>
					<?php
				}
				?>
			...
			<header class="noFixMenu menu_<?php echo get_custom_option('menu_align'); ?> <?php echo get_custom_option('show_user_menu')!='yes' ? 'without' : 'with'; ?>_user_menu">
				...
				<div class="topWrap" <?php echo $header_style; ?>>
			...
			if (!empty($show_user_header) && $show_user_header != 'none') {
				...
				if (!empty($user_header)) {
					...
					?>
					<div class="userHeaderSection <?php echo $show_user_header; ?>">
						<?php
