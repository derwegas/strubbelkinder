...
define( 'NOTIFIER_THEME_NAME', 'Kindergarten' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'kinder' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_kinder.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
